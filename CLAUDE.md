...
| Overlays | `js/overlays/` | Resolve *before* the tile they sit on. Mystery boxes are **banked** by upgrades and thrown onto the board when the player returns to it — state first, animation on top. → [README](js/overlays/README.md) |
