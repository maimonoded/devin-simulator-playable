...
const CARD_SEASONS = [
  {
    ...
    sets: [
      ...
      { key: "the-suite", name: "The Honeymoon Suite", cards: [
        ...
        { id: "a-cold-radiator",   name: "A Cold Radiator",            rarity: C, art: "a-cold-radiator.webp"  },
        { id: "two-in-the-morning",name: "Two in the Morning",         rarity: C, art: "two-in-the-morning.webp"  },
      ...
      { key: "the-reveal", name: "The Reveal", cards: [
        { id: "missing-notice",    name: "A Missing-Person Notice",    rarity: C, art: "missing-notice.webp"  },
        { id: "old-headline",      name: "A Six-Month-Old Headline",   rarity: C, art: "old-headline.webp"  },
        { id: "unopened-letter",   name: "An Unopened Letter",         rarity: C, art: "clue-will.webp" },
        { id: "law-firms-crest",   name: "A Law Firm's Crest",         rarity: C, art: "law-firms-crest.webp"  },
        { id: "a-dictaphone",      name: "A Dictaphone",               rarity: C, art: "a-dictaphone.webp"  },
        { id: "a-lobby-window",    name: "A Lobby Window",             rarity: C, art: "a-lobby-window.webp"  },
