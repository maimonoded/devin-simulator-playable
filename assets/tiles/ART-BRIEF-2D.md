# Tile art brief — flat PNG (legacy CSS board)

> This is the brief for the **legacy CSS-3D board** (`cfg.board3d = 0`), which skins tiles with
> flat `N.png` artwork. The live board is WebGL and takes 3D models — for that, use
> [ART-BRIEF.md](ART-BRIEF.md). Only use this one if you're specifically targeting the fallback.
