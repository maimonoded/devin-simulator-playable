...
#
# It finishes by reminding you that the skills need the Scenario MCP server. That is a
...
echo
echo "These skills generate their art through Scenario (scenario.com), reached over its"
