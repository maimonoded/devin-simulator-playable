/* The people on the board.
   ...
   Imported by js/ui/board3d.js, like js/ui/env3d.js and js/ui/shoe3d.js and for the same reason —
...
export const NPC3D = {
  ...
  /* One load per character, and once only: the group survives a board rebuild the way the token
     does. The token learned that the expensive way — re-fetching on every rebuild left a
     placeholder on screen for the length of the download. */
  _load() {
